...
namespace EigenValue_Problem
{
    ...
    public partial class OldForm : Form
    {
        ...
        private void SectionComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "C - Section lipped with fillet":
                    ...
                    souttextbox.Hide();
                    break;
                case "C - Section lipped with no fillet":
                    ...
                    souttextbox.Hide();
                    break;
                case "C - Section with fillet (no lip)":
                    ...
                    souttextbox.Hide();
                    break;
                case "C - Section with no fillet (no lip)":
                    ...
                    souttextbox.Hide();
                    break;
                case "Z - Section lipped with fillet":
                    ...
                    souttextbox.Hide();
                    break;
                case "Z - Section lipped with no fillet":
                    ...
                    souttextbox.Hide();
                    break;
                case "Z - Section with fillet (no lip)":
                    ...
                    souttextbox.Hide();
                    break;
                case "Z - Section with no fillet (no lip)":
                ...
                case "HAT-Section with fillet":
                    ...
                    souttextbox.Show();
                    break;
                case "HAT-Section with no fillet":
                ...
                case "General":
                    ...
                    //foreach (string m in linesOfM)
                    //{
                    //int mNum = int.Parse(m);
                    //foreach (string n in linesOfN)
                    //{
                    //int nNum = int.Parse(n);
                    //for (int i = 8 * (mNum - 1) + 1; i < 8 * (mNum - 1) + 2; i++)
                    //{
                    //for (int j = 8 * (nNum - 1) + 1; j < 8 * (nNum - 1) + 2; j++)
                    //{
                    //ekemene,fd[i, j] =InsertKeyMode
        ...
        private void btndesigncompression_Click(object sender, EventArgs e)
        {
            ...
            PulltextBox.Text = design.Pull.ToString();
            PuldtextBox.Text = design.Puld.ToString();
            PulgtextBox.Text = design.PulG.ToString();
        }
        ...
        private void btndesignmoment_Click(object sender, EventArgs e)
        {
            ...
            MulltextBox.Text = design.Mull.ToString();
            MuldtextBox.Text = design.Muld.ToString();
            MulLTBtextBox.Text = design.MulLTB.ToString();
        }
